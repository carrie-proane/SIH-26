...
- Same-sample promotion rule and model evidence checklist:
  `docs/benchmarks/matcher-promotion.md`.
...
- Automatic scored frame extraction/selection, optional handoff validation, and COLMAP
  feature/match/map/PLY flow: `src/sih26158/pipeline.py`,
  `src/sih26158/preprocessing/frames/`, and
  `src/sih26158/reconstruction/colmap.py`.
...
- Backend walkthrough: `docs/guides/backend-demo.md`.
