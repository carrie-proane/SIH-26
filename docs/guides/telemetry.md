...
```
src/sih26158/preprocessing/telemetry/
...
docs/contracts/telemetry-fields.md  what DJI emits, traps found
data/schemas/                  normalized_telemetry.schema.md  <-- the contract
docs/guides/sample-data.md     bundle registry + capture protocol
```
...
layouts. Sample bundles: blocked on capture - see `docs/guides/sample-data.md`.
