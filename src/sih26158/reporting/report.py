...
from ..reconstruction.confidence import confidence_contract
...
def build_quality_report(
    ...
    *,
    ...
    surface_completion: dict[str, Any] | None = None,
) -> dict[str, Any]:
    registration_rate = metrics.registration_rate
    alignment = alignment or {}
    scene_analysis = scene_analysis or {}
    frame_quality = frame_quality or {}
    surface_completion = surface_completion or {
        "status": "DISABLED",
        "measurement_eligible": False,
        "reason": "Surface completion was not requested for this run.",
    }
    ...
    return {
        ...
        "limitations": [
            ...
            "Unseen surfaces are never claimed as measured; any predicted surface is visual-only.",
        ],
    }
